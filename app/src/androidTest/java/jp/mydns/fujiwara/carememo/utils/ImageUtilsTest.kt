...
class ImageUtilsTest {
    ...
    @Test
    fun IMG_01_processAndSaveImage_success() {
        runBlocking {
    ...
    @Test
    fun IMG_02_processAndSaveImage_rotation_correction() {
        runBlocking {
    ...
    @Test
    fun IMG_03_processAndSaveImage_resize() {
        runBlocking {
    ...
    @Test
    fun IMG_04_processAndSaveImage_read_failure() {
        runBlocking {
    ...
    @Test
    fun IMG_05_processAndSaveImage_save_failure() {
        runBlocking {
    ...
    @Test
    fun FIL_01_deleteImageFiles_success() {
        runBlocking {
            val photosDir = ImageUtils.getPhotosDirPublic(context)
    ...
    @Test
    fun FIL_02_deleteImageFiles_failure() {
        runBlocking {
            val photosDir = ImageUtils.getPhotosDirPublic(context)
    ...
    @Test
    fun FIL_03_clearPhotosDir_success() {
        runBlocking {
            val photosDir = ImageUtils.getPhotosDirPublic(context)
    ...
    @Test
    fun FIL_04_clearPhotosDir_failure() {
        runBlocking {
            val photosDir = ImageUtils.getPhotosDirPublic(context)
    ...
    @Test
    fun TMP_02_clearOldTempPhotos_success() {
        runBlocking {
