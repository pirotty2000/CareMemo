...
|:---------|:-------------------------|:-------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| 利用者一覧    | `MainScreen`             | `PersonListViewModel`                                  | `PersonRepository`<br>`DeleteOrRestorePersonRepository`<br>`PersonSummaryRepository`        |
...
| 5. (B) 所見メモ          | `PersonConditionScreen`<br>`*Phone.kt`<br>`*Tablet.kt`<br>`*Content.kt`  | 🔴**`base/DeleteConfirmDialog.kt`**：写真削除等の警告ダイアログ<br>🔴**`base/SearchBox.kt`**：共通検索バー<br>🔴**`common/HistoryComponents.kt`**：共通の履歴リスト基盤<br>`condition/PersonConditionComponents.kt`：(B)専用の表示・編集・写真グリッド                                                                                                                                        |
